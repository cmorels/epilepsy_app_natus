...
procesar_puerto_window(channels_A, 'A', mouse_id_A, v, time, fs, session_date, session_time, date_time, export_window_sec);
procesar_puerto_window(channels_B, 'B', mouse_id_B, v, time, fs, session_date, session_time, date_time, export_window_sec);
